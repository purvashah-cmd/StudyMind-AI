    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400">Login to your StudyMind AI account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full btn-primary py-3 rounded-xl flex justify-center items-center font-semibold text-lg shadow-blue-500/30 hover:shadow-blue-500/50"
          >
            Sign In
          </button>
        </form>
